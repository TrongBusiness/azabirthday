...
//   var aza = document.createElement("img");
//         aza.setAttribute("src", "aza.PNG");
//         document.querySelector('#box').appendChild(aza);


  var audioPlay = document.createElement("audio");
        audioPlay.setAttribute("src", "./aza.mp3");
        document.querySelector('#audio').appendChild(audioPlay);
...
//         document.querySelector('.box').appendChild(ifrm);
